...
highlight("Vertibird-2");
highlight("The Prydwen");
highlight("Liberty Prime")
highlight("Brotherhood Of Steel Soldier-3");
highlight("Billboard");
highlight("Tree-1");
highlight("Airport Terminal");
highlight("Radio Tower");
